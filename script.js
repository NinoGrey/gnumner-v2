...
const RED_KEYWORDS = ['ԿԱՀՈՒՅՔ', 'ծառայություն', 'ՕԴՈՐԱԿԻՉ', 'ՀԱՄԱԿԱՐԳԻՉ','ՀԱՄԱԿԱՐԳՉԱՅԻՆ', 'պլանշետներ', 'վերկառուցուման','կենցաղային', 'աշխատանք', 'տեխնիկա', 'լուծում','կազմակերպման', 'բարեկարգման','սարքավորում','էլեկտրական','մեքենա', 'շինարարական', 'շինարար','Դեղորայք','պատվաստանյութ', 'ԿԱՆԱՉԱՊԱՏ','բարեկարգման','Համակարգիչ','վառելիք', 'քարթիրջներ', 'համակարգ','սարքերի', 'պահեստամասեր','ավտոմեքենա', 'լաբորատոր', 'պարագաներ', 'միջոցառում', 'փորձաքննութ', 'փաստաթղթեր', 'գործիք', 'հիմնանորոգ']; 
